...
contract Auction {
    ...
    */
    ...
    tokenDetails[msg.sender].remainingTokens; //updating the same balance in bidders map.
     ...
     function revealWinners() public onlyOwner(msg.sender) {
    ...
    //** end code here*
     ...
     //Miscellaneous methods: Below methods are used to assist Grading. PleaseDONOT CHANGE THEM.
